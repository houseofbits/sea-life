...
<template>
    ...
    <div class="edu1-information-block page4-position">
        <div class="small-header">{{ lang('edu1.page4.title') }}</div>

        <div class="text-block mb40" v-html="lang('edu1.page4.text1')"/>

        <div class="text-block" v-html="lang('edu1.page4.text2')"/>

        <div class="cards-block">
            <div class="card">
                <div class="title">{{ lang('edu1.page4.subtitle1') }}</div>

                <WaterLevel :is-active="active1" :wave-x="-160" :wave-y="20" :wave-scale="1.0"/>

                <div class="sub-title">{{ lang('edu1.page4.subtitle1.text') }}</div>
            </div>
            <div class="card">
                <div class="title">{{ lang('edu1.page4.subtitle2') }}</div>

                <WaterLevel :is-active="active1" :wave-x="-180" :wave-y="10" :wave-scale="1.2">
                    <svg width="50" height="50" viewBox="0 0 26 27" fill="none" class="sailboat"
                ...
                <div class="sub-title">{{ lang('edu1.page4.subtitle2.text') }}</div>
            </div>
        </div>

        <div class="note">{{ lang('edu1.page4.note') }}</div>
    </div>
