...
watch(() => detailContent.value, (value) => {
    specie1.value = findItemByIdentifier("8");
    specie2.value = findItemByIdentifier("12");
});
        ...
        <div class="page3-waves-block">
            <div class="waves-graphic">
                <div class="static-wrapper">
                    <div class="title">Dabiskās populācijas izmaiņas Baltijas jūrā</div>
            ...
            <div class="text">
                Atsevišķu Latvijas faunai raksturīgu zivju dabiskās populācijas Baltijas jūrā ir izzudušas, piemēram,
                Atlantijas store, kas pēdējo reizi tika noķerta 1996. gadā Igaunijas piekrastē. Tās populācija kopš
                2006. gada Baltijas jūras baseinā tiek atjaunota un mākslīgi pavairota.
                <br/>
                Parādās arī jaunas sugas, piemēram, apaļais jūrasgrundulis, kura dabiskais izplatības areāls ir Azovas,
                Melnās un Kaspijas jūras reģionā.
            </div>
        </div>
    </div>
